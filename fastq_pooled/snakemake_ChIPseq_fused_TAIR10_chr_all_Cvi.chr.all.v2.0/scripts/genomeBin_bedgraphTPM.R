...
# deepTools bamCoverage-generated *{genomeBinName}.bedgraph files

# Usage:
# ./genomeBin_bedgraphTPM.R WT_DMC1_V5_Rep2_ChIP fused_TAIR10_chr_all_Cvi.chr.all.v2.0 both 10000
...
sampleProfile <- read.table(paste0("mapped/", align, "/bg/",
                                   ...
                                   align, "_sort_dtnorm_binSize", genomeBinName, ".bedgraph"))
...
#RPK <- sampleProfile$V4 / (genomeBinSize/1e3)
RPK <- sampleProfile$V4 / ((sampleProfile$V3-sampleProfile$V2)/1e3)
...
print("Sum of genomeBinSize TPM =")
print(sum(TPM))
...
write.table(bedgraph,
            file = paste0("mapped/", align, "/bg/",
                          sampleName, "_MappedOn_", refbase,
                          "_lowXM_", align, "_sort_TPM_binSize", genomeBinName, ".bedgraph"),
