...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript variant_freq_gene_quantile_metaprofiles.R SNP_INDEL '/data/public_data/arabidopsis/MPIPZ_Jiao_Schneeberger_2020_NatCommun/Ler' unique 'Chr1,Chr2,Chr3,Chr4,Chr5' 2200 2000 2kb '2 kb' 10 10bp genes genomewide 6 fused_TAIR10_chr_all_Ler.chr.all.v2.0 '0.02,0.96'
