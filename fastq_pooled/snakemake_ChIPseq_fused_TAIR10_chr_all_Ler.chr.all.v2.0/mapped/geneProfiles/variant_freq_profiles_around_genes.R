...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript variant_freq_profiles_around_genes.R SNP_INDEL '/data/public_data/arabidopsis/MPIPZ_Jiao_Schneeberger_2020_NatCommun/Ler' 'Chr1,Chr2,Chr3,Chr4,Chr5' 2200 2000 2kb 10 10bp genomewide fused_TAIR10_chr_all_Ler.chr.all.v2.0
