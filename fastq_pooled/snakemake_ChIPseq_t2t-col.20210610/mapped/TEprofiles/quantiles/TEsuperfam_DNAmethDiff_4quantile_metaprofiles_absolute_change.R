...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript TEsuperfam_DNAmethDiff_4quantile_metaprofiles_absolute_change.R 'cmt3_BSseq_Rep1' 'WT_BSseq_Rep2_2013,WT_BSseq_Rep3_2013' 'kss_BSseq_Rep1' 'WT_BSseq_Rep2_2013,WT_BSseq_Rep3_2013' both 'Chr1,Chr2,Chr3,Chr4,Chr5' 2000 2000 2kb '2 kb' 10 10bp bodies CHG Gypsy_LTR 4 t2t-col.20210610 '0.02,0.96'
