...
# decreasing log2_fold change in DNA methylation or randomly

# Usage:
# /applications/R/R-4.0.0/bin/Rscript TEsuperfam_DNAmethDiff_quantile_metaprofiles_log2_fold_change.R 'cmt3_BSseq_Rep1' 'WT_BSseq_Rep2_2013,WT_BSseq_Rep3_2013' 'kss_BSseq_Rep1' 'WT_BSseq_Rep2_2013,WT_BSseq_Rep3_2013' both 'Chr1,Chr2,Chr3,Chr4,Chr5' 2000 2000 2kb '2 kb' 10 10bp bodies CHG Gypsy_LTR 6 t2t-col.20210610 '0.02,0.96'
...
outDir <- paste0(paste0(chrName, collapse = "_"),
                 "/quantiles_by_", context, "_log2_fold_change_at_", superfamName, "_", sortRegion, "/")
...
ggsave(paste0(plotDir,
              ...
              "_by_", context, "_log2_fold_change_in_", libName1[1], "_", libName2[1],
