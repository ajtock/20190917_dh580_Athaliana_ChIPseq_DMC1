...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript hypoCHG_DMR_quantile_metaprofiles_absolute_change.R CHG '/home/ajt200/analysis/BSseq_leaf_Stroud_Jacobsen_2013_Cell_2014_NSMB' both 'Chr1,Chr2,Chr3,Chr4,Chr5' 1000 2000 2kb '2 kb' 10 10bp DMRs genomewide 6 t2t-col.20210610 '0.02,0.96'
...
featuresAcc1_ortho_DF <- readGFF(
  paste0(dirName,
         ...
         "_by_change_in_cmt3_BSseq_Rep1_hypo", context, "_", orderRegion,
         "_vs3reps_mbins_bS100_tfisher_pVT0.01_mCC4_mRPC4_mPD_0.4_0.2_0.1_mG200",
         "_in_", refbase, "_",
         paste0(chrName, collapse = "_"), "_", genomeRegion, ".gff3"))
...
featuresAcc1_ortho_DF_bed <- read.table(
  paste0(dirName,
         ...
         "_vs3reps_mbins_bS100_tfisher_pVT0.01_mCC4_mRPC4_mPD_0.4_0.2_0.1_mG200",
         "_in_", refbase, "_",
         paste0(chrName, collapse = "_"), "_", genomeRegion, ".bed"),
  header = FALSE, sep = "\t")
...
featuresAcc2_ortho_DF <- readGFF(
  paste0(dirName,
         "/snakemake_BSseq_", refbase, "/coverage/report/DMRs/hypoDMRs/",
         paste0(chrName, collapse = "_"), "/",
         "features_", quantiles, "quantiles",
         "_by_change_in_kss_BSseq_Rep1_hypo", context, "_", orderRegion,
         "_vs3reps_mbins_bS100_tfisher_pVT0.01_mCC4_mRPC4_mPD_0.4_0.2_0.1_mG200",
         "_in_", refbase, "_",
         paste0(chrName, collapse = "_"), "_", genomeRegion, ".gff3"))
