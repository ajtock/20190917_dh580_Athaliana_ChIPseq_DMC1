...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript genes_crossovers_hypoDMRs4sets_Gypsy_CENAthila_nonCENAthila_CEN180_4metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 2000 '2kb' 10 10 10bp 10bp '0.02,0.96' 'Col_DMC1_V5_Rep1_ChIP,Col_DMC1_V5_Rep2_ChIP,cmt3_DMC1_V5_Rep1_ChIP,kss_DMC1_V5_Rep1_ChIP' '20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_t2t-col.20210610,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_t2t-col.20210610,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_t2t-col.20210610,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_t2t-col.20210610' 'Col Rep1,Col Rep2,cmt3,kss' 'dodgerblue1,navy,green2,darkorange' 'DMC1 ChIP' Gypsy_LTR
...
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("Col Rep1,Col Rep2,cmt3,kss",
#                                 split = ","))
...
log2ChIP_mats <- mclapply(seq_along(log2ChIP_CEN180Mats), function(x) {
  list(
       # CEN180s
...
}, mc.cores = length(log2ChIP_CEN180Mats))
